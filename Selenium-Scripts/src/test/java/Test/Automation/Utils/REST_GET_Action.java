...
public class REST_GET_Action {
    ...
    public static String POSTRequest(String APIUrl,String requestBody) throws IOException {
        String resposneID = "";
        FileInputStream postBody = new FileInputStream(new File(	"src/test/resources/Etisalat_DigitalApp/Request/"+requestBody+".json"));
        POSTResponse=
        ...
        String resultFormat = "name";
//                readFromCell("TestData","resultFormat",1,"sampleName");
