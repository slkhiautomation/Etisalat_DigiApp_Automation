...
//        WebElement element = driver.findElement(By.xpath(xpath));
    ...
    public static WebElement getElementByXpathWithoutWait(String xpath){
        WebElement element = driver.findElement(By.xpath(xpath));
        return element;
    }
...
//    }
    ...
    } public static void scrollToAndroidElement(WebElement scrollTo) {
        int x = scrollTo.getLocation().getX();
        int y = scrollTo.getLocation().getY();
...
//            element2.click();
    ...
    public static void waitForVisibilityAndroid(AndroidElement element) {
